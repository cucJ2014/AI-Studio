...
class MobileNetV2():
    def __init__(self, scale=1.0, change_depth=False):
        ...
        self.global_name = "mobilenetv2_"+str(scale)+'_'
    ...
    def net(self, input, class_dim=1000):
        ...
        for layer_setting in bottleneck_params_list:
            ...
            input = self.invresi_blocks(
                ...
                n=n,
                s=s,
                name=self.global_name + 'conv' + str(i))
            in_c = int(c * scale)
        #last_conv
        input = self.conv_bn_layer(
            input=input,
        ...
        output = fluid.layers.fc(input=input,
                                 size=class_dim,
                                 param_attr=ParamAttr(name=self.global_name + 'fc10_weights'),
                                 bias_attr=ParamAttr(name=self.global_name + 'fc10_offset'))
        return output
